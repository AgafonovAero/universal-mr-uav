...
% IMU noise and bias terms are disabled for deterministic reruns.
...
% Barometer noise and bias terms are disabled for deterministic reruns.
params.sensors.baro.alt_bias_m = 0.0;
params.sensors.baro.alt_noise_std_m = 0.0;

% GNSS noise and bias terms are disabled for deterministic reruns.
...
% Magnetometer noise and bias terms are disabled for deterministic reruns.
