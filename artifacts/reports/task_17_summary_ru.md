...
Причина, с которой TASK-17 был начат после TASK-16, ранее фиксировалась
следующими сообщениями `ArduPilot`:
...
- первый управляемый расчетный прогон не выполнен, поскольку ненулевые
  команды ШИМ и ненулевые команды частоты вращения винтов не подтверждены.
