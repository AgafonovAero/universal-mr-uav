...
> Примечание:
> этот файл отражает исходный результат TASK-08A.
> Актуализированная проверка ветки после подтягивания к современному `main`
> зафиксирована отдельно в
> `artifacts/reports/task_08a_refresh_summary_ru.md`.
