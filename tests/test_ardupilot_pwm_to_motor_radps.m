...
%TEST_ARDUPILOT_PWM_TO_MOTOR_RADPS Tests for PWM-to-motor conversion.
...
pwm_us = [1000.0; 1500.0; 2000.0; 2200.0];
motor_cmd_radps = uav.ardupilot.pwm_to_motor_radps(pwm_us, params, cfg);
