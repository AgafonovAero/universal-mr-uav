...
launch_info = local_build_launch_info(cfg, wsl_log_path, wsl_pid_path, wsl_exit_path, wsl_wrapper_path);
...
function launch_info = local_build_launch_info(cfg, wsl_log_path, wsl_pid_path, wsl_exit_path, wsl_wrapper_path)
